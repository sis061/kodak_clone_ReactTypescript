    ...
    <div>
      ...
      >
        <img
          ...
          src={"/kodak_clone_ReactTypescript/img/section05_00" + props.items + ".jpg"}
...
let arrowNextStyle: React.CSSProperties = {
  ...
  right: "-80px",
  zIndex: "5",
  backgroundImage: "url(/kodak_clone_ReactTypescript/img/009_next_btn.png)",
  width: "30px",
  height: "90px",
  backgroundSize: "100%",
...
let arrowPrevStyle: React.CSSProperties = {
  ...
  left: "-80px",
  zIndex: "5",
  backgroundImage: "url(/kodak_clone_ReactTypescript/img/010_prev_btn.png)",
  width: "30px",
  height: "90px",
  backgroundSize: "100%",
  backgroundRepeat: "no-repeat",
