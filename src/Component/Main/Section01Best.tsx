    ...
    <div className="col-md-3 tabItem">
      ...
      >
        ...
        >
          ...
          <img
            src={"/kodak_clone_ReactTypescript/"+Items.imgUrl}
            alt={Items.alt}
            className={isHovering ? "prodImginactive" : "prodImgactive"}
          />
          <img
            src={"/kodak_clone_ReactTypescript"+Items.imgUrlSub}
            alt={Items.alt}
        ...
        <div className="tabIcon">
          <img src="/kodak_clone_ReactTypescript/img/011_heart_icon.png" alt="찜 아이콘" />
          <img src="/kodak_clone_ReactTypescript/img/012_cart_icon.png" alt="장바구니 아이콘" />
        </div>
      </Nav.Link>
    </div>
  );
