...
function Section04Box01(_props: RecItemModalProps): JSX.Element {
  ...
  return (
    <div className="col sm section04Box">
      ...
      >
        <img
          src="/kodak_clone_ReactTypescript/img/section04_top_product001.jpg"
          alt="추천상품 모자 Top Img"
        />
...
function Section04Box02(_props: RecItemModalProps) {
  ...
  return (
    <div className="col sm section04Box">
      ...
      >
        <img
          src="/kodak_clone_ReactTypescript/img/section04_top_product002.jpg"
          alt="추천상품 신발 Top Img"
        />
...
function Section04Box03(_props: RecItemModalProps) {
  ...
  return (
    <div className="col sm section04Box">
      ...
      >
        <img
          src="/kodak_clone_ReactTypescript/img/section04_top_product003.jpg"
          alt="추천상품 가방 Top Img"
        />
  ...
  return (
    ...
    >
      <div className="recImgBox">
        ...
        <img src={"/kodak_clone_ReactTypescript/"+Items.imgUrl} alt={Items.alt} />
      </div>
