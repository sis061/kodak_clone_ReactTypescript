            ...
            <Container>
                <Row>
                    <div className="footerLeft col sm=4.5 ">
                        <img src='/kodak_clone_ReactTypescript/img/footer_bi.png' className='footerLogo' alt='footerLogo'/>
                            ...
                            <ul>
                                ...
                                <li style={{ float: 'left' }}>
                                    <Link to={' '} className='socialBtn'>
                                        <img src='/kodak_clone_ReactTypescript/img/new_kakaoplus.png' alt='카카오플러스 링크'/>
                                    </Link>
                                    <Link to={' '} className='socialBtn'>
                                        <img src='/kodak_clone_ReactTypescript/img/new_facebook.png' alt='페이스북 링크'/>
                                    </Link>
                                    <Link to={' '} className='socialBtn'>
                                        <img src='/kodak_clone_ReactTypescript/img/new_instagram.png' alt='인스타그램 링크'/>
                                    </Link>
                                </li>
                            </ul>
                        </div>
