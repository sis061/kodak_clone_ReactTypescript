    ...
    <div className="prodDetail_C">
      ...
      <div className="prdtBottom">
        <div className="prodtAdditional">
          <img src="/kodak_clone_ReactTypescript/img/SubImg/detail_common_clear.jpg" alt={Ids.alt} />
          <img
            ref={Tabs[0].element}
            src="/kodak_clone_ReactTypescript/img/SubImg/detail_common_about.jpg"
            alt={Ids.alt}
          />
          ...
          <img src="/kodak_clone_ReactTypescript/img/SubImg/detail_common_license.jpg" alt={Ids.alt} />
          <img
            ref={Tabs[1].element}
            src="/kodak_clone_ReactTypescript/img/SubImg/detail_common_deliver.jpg"
            alt={Ids.alt}
          />
        </div>
      </div>
      ...
      >
        <div className="infoArea">
          ...
          <div className="naver_btnWrap">
            <img src="/kodak_clone_ReactTypescript/img/naver.png" alt="네이버결제" />
          </div>
        </div>
      </div>
    </div>
          ...
          <div className="summaryL">
            <div className="summaryLScore">
              <div className="summaryLIcon">
                <img src="/kodak_clone_ReactTypescript/img/star_icon.png" alt="별 아이콘" />
              </div>
                ...
                <div className="reviewListLike">
                  <div className="reviewListLikeContainer">
                    <div className="reviewListLikeBtn likeBtn">
                      <img src="/kodak_clone_ReactTypescript/img/thumb_up_icon.png" alt="추천 아이콘" />
                      <span>도움돼요</span>
                    </div>
                    <div className="reviewListLikeBtn unlikeBtn">
                      <img src="/kodak_clone_ReactTypescript/img/thumb_down_icon.png" alt="비추천 아이콘" />
                      <span>도움안돼요</span>
                    </div>
